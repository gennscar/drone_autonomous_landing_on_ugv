...
class kf_xyz_estimator(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("yaw_subscriber_topic", "/LS_drone_rover_uwb_estimator/estimated_yaw")
    ...
    def callback_uwb_subscriber(self, msg):
        ...
        drone_est_pos_ROV = np.array([msg.pose.pose.position.x, msg.pose.pose.position.y, msg.pose.pose.position.z])
        rot_rover_to_NED = (R.from_euler(
            'z', self.kalman_filter_.x[13][0], degrees=False))

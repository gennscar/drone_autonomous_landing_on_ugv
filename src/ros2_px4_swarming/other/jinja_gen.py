...
if __name__ == "__main__":
    ...
    parser.add_argument('--anchor_id', default=0, help="ID of the simulated drone")
    parser.add_argument('--namespace', default="X500_0/GroundTruth", help="ROS namespace of the simulated drone")
